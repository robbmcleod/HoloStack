...
% iptcheckinput(fixedImage,{'logical','numeric'},{'nonsparse','2d','finite'},mfilename,'fixedImage',1)
iptcheckinput(movingImage,{'logical','numeric'},{'real','nonsparse','2d','finite'},mfilename,'movingImage',2)
% iptcheckinput(movingImage,{'logical','numeric'},{'nonsparse','2d','finite'},mfilename,'movingImage',2)
